    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
      <div class="app-brand demo">
        <a href="dashboard.php" class="app-brand-link">
          ...
          <span class="app-brand-text demo menu-text fw-semibold ms-2">Hotel & Events</span>
        </a>
      ...
      <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="room-types.php" class="menu-link">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="home-description.php" class="menu-link">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item"><a href="form-layouts-vertical.php" class="menu-link"><div>Vertical Form</div></a></li>
            <li class="menu-item"><a href="form-layouts-horizontal.php" class="menu-link"><div>Horizontal Form</div></a></li>
          </ul>
        </li>
