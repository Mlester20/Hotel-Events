          ...
          <div class="card p-sm-7 p-2">
            ...
            <div class="app-brand justify-content-center mt-5">
              <a href="index.php" class="app-brand-link gap-3">
                ...
                <span class="app-brand-text demo text-heading fw-semibold">Hotel & Events</span>
              </a>
            </div>
            <!-- /Logo -->
            ...
            <div class="card-body mt-1">
              ...
              <form id="formAuthentication" class="mb-5" action="controllers/auth.php" method="POST">
